...
<html>
    ...
    <head>
        <title>Assignment 4 - Individual Product Page</title>
...
for record in products: # Creates and displays relevant info for each product in catalogue
    ...
    print "<br>"
    print "<br>"
    print "<button id='addButton_"+record['id']+"'>Add "+record['name']+" to wishlist</button>"
    print "<button id='removeButton_"+record['id']+"'>Remove "+record['name']+" from wishlist</button>"
    print "<p>Description: "+record['description']
    print "<p>Cost: $"+record['cost']
